  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-10 w-96 h-96 bg-purple-600 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse" style={{animationDelay: '700ms'}}></div>
        <div className="absolute bottom-20 left-1/2 w-96 h-96 bg-indigo-600 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-pulse" style={{animationDelay: '1000ms'}}></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-20">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="mb-8 space-y-4" style={{animation: 'slideUp 1s ease-out'}}>
          ...
          <div className="max-w-3xl mx-auto mb-12" style={{animation: 'slideUp 1s ease-out 0.2s backwards'}}>
            <div className="backdrop-blur-md bg-gray-800/60 rounded-3xl p-8 border border-blue-500/30 shadow-2xl" style={{animation: 'glow 3s ease-in-out infinite'}}>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-wrap justify-center gap-6 mb-16" style={{animation: 'slideUp 1s ease-out 0.4s backwards'}}>
            <NavLink
            to="/project"
          ...
          <div className="max-w-4xl mx-auto" style={{animation: 'slideUp 1s ease-out 0.6s backwards'}}>
            <h3 className="text-gray-400 text-sm uppercase tracking-widest mb-6 font-semibold">
              Công nghệ sử dụng
            </h3>
